...
# Arguments: 1. Run number of muon telescope run, 2. Run number of ptrg run, 3. Title string to add to
#     figures
#     N.B. there are also many important parameters in calibsettings.py
# Run with (e.g.):
#    python3 telescope_comparison.py 4004 4080 HG = 20
#    python3 telescope_comparison.py 2928 4081 HG = 50, Horizontal Orientation
...
if __name__ == "__main__":
    ...
    for i in lastargs:
        title += i + ' '
    c = calibrate(sys.argv[1],sys.argv[2],title,homedir,fitrange)
    c.telescope_control()
    c.savehistos()
